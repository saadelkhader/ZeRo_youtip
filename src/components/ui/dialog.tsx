...
>(({ className, children, showClose = true, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 flex max-h-[90dvh] w-[calc(100vw-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-2xl border border-border-light bg-surface-card shadow-elevated focus:outline-none data-[state=open]:animate-slide-up",
        className,
      )}
      {...props}
    >
